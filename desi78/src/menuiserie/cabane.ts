...
const pDef: tParamDef = {
	...
	params: [
		...
		pNumber('rab', 'ratio', 1.618, 0.5, 4, 0.001),
		pNumber('W1', 'mm', 200, 20, 800, 1),
		pNumber('W2', 'mm', 200, 20, 800, 1),
		pNumber('N1', 'planches', 8, 2, 20, 1),
...
function pGeom(t: number, param: tParamVal, suffix = ''): tGeom {
	...
	try {
		...
		// step-6 : any logs
		rGeome.logstr += `cabane: height-int ${ffix(Hi / 1000)}  height-ext ${ffix(Hg / 1000)}  width-ext ${ffix(Lg / 1000)} m\n`;
...
const cabaneDef: tPageDef = {
	pTitle: 'Cabane',
	pDescription: 'A cabane for kids',
	pDef: pDef,
	pGeom: pGeom
};
