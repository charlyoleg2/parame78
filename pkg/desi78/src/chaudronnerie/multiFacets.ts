...
const pDef: tParamDef = {
	...
	params: [
		...
		pNumber('W1', 'mm', 500, 1, 200, 1),
		pNumber('W2', 'mm', 500, 1, 200, 1),
		pNumber('W3', 'mm', 500, 1, 200, 1),
		pNumber('W4', 'mm', 500, 1, 200, 1),
		pSectionSeparator('Intern'),
		pNumber('V1', 'mm', 500, 1, 200, 1),
		pNumber('V2', 'mm', 500, 1, 200, 1),
		pNumber('V3', 'mm', 500, 1, 200, 1),
		pNumber('V4', 'mm', 500, 1, 200, 1),
